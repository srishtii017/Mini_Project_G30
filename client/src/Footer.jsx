export default function Footer(){
    return (
        <>
            <div className="pin-b pt-14 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-3xl md:px-24 lg:px-4">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
                            <svg className="w-8 text-primary text-deep-purple-accent-400" viewBox="0 0 24 24"  stroke="currentColor" fill="none">
                                <rect x="3" y="1" width="7" height="12"></rect>
                                <rect x="3" y="17" width="7" height="6"></rect>
                                <rect x="14" y="1" width="7" height="6"></rect>
                                <rect x="14" y="11" width="7" height="12"></rect>
                            </svg>
                            <span className="ml-2 text-xl font-bold tracking-wide text-primary uppercase">VibeVillas</span>
                        </a>
                    ...
                    <div className="space-y-2 text-sm">
                        <p className="text-base font-bold tracking-wide text-primary">Contacts</p>
                        <div className="flex">
                        ...
                        <div className="flex">
                            <p className="mr-1 text-primary">Email:</p>
                        ...
                        <div className="flex">
                            <p className="mr-1 text-primary">Address:</p>
                    ...
                    <div>
                        <span className="text-base font-bold tracking-wide text-primary">Social</span>
                ...
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t border-primary lg:flex-row">
